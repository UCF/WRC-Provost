...
#title { position:relative; height:65px; background:url('<?=PROVOST_IMG_URL?>/update-title.jpg') no-repeat top left; }
...
<div id="main">
	...
	<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 600px; margin:0 auto; background-color: #fff;">
		<tr><td height="37" style="border-bottom: 2px solid #FFC904; background-color: #000; padding-left: 20px;"><a href="http://www.ucf.edu/"><img alt="University of Central Florida" src="<?=PROVOST_IMG_URL?>/update-ucf.gif"></a></td></tr>
		<tr><td>
