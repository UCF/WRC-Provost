...
/**
 * Hide Page Links To metabox on Form CPT create/update view
 * http://tinyurl.com/qbskpcs
 **/
function remove_posts_from_page_links_to( $types ) {
    return array_diff( $types, array( 'wrc_form' ) );
}
add_filter( 'page-links-to-post-types', 'remove_posts_from_page_links_to' );
